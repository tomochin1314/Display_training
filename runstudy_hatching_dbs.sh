...
BINDIR=${BASEDIR}/bin/hatching_dbs
TASKDIRS="pretask task1 task2 task6"
EXECUTABLES="singleitr_hatching_dbs multiviewitr_hatching_dbs multiwindowitr_hatching_dbs"
...
function pretask()
{
	...
	${BINDIR}/pretask/singleitr_hatching_dbs \
...
function task1()
{
	...
	do
		...
		do
			...
			${BINDIR}/task1/singleitr_hatching_dbs \
			-f \
...
function task2()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task2/singleitr_hatching_dbs \
			-f \
...
function task3()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task3/singleitr_hatching_dbs \
			-f \
...
function task4()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task4/singleitr_hatching_dbs \
			-f \
...
function task5()
{
	...
	do
		...
		do
			...
			${BINDIR}/task5/singleitr_hatching_dbs \
			-f \
       ...
       #local trichoices=(rightcut nocut leftcut nocut rightcut)
        ...
        do
                ...
                do
                        ...
                        ${BINDIR}/task6/singleitr_hatching_dbs \
                        -f \

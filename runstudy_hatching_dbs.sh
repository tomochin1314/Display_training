...
BINDIR=${BASEDIR}/bin/hatching
TASKDIRS="pretask task1 task2 task3 task4 task5 task6"
EXECUTABLES="singleitr_hatching multiviewitr_hatching multiwindowitr_hatching"
...
function pretask()
{
	...
	${BINDIR}/pretask/singleitr_hatching \
...
function task1()
{
	...
	do
		...
		do
			...
			${BINDIR}/task1/singleitr_hatching \
			-f \
...
function task2()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task2/singleitr_hatching \
			-f \
...
function task3()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task3/singleitr_hatching \
			-f \
...
function task4()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task4/singleitr_hatching \
			-f \
...
function task5()
{
	...
	do
		...
		do
			...
			${BINDIR}/task5/singleitr_hatching \
			-f \
       ...
       #local trichoices=(rightcut nocut leftcut nocut rightcut)
        ...
        do
                ...
                do
                        ...
                        ${BINDIR}/task6/singleitr_hatching \
                        -f \

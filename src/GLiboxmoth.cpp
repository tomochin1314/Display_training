 ...
 */
void CGLIBoxApp::accFrustum(GLdouble left, GLdouble right, GLdouble bottom, 
 ...
 */
void CGLIBoxApp::accPerspective(GLdouble fovy, GLdouble aspect, 
...
void CGLIBoxApp::display_pass_fixed()
{
    glDrawBuffer( GL_BACK_LEFT );
	glClear( GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT );
	if ( m_bStereo ) {
...
void CGLIBoxApp::display_accum(GLint nsamples)
{
    srand(1973);

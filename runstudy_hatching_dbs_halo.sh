...
BINDIR=${BASEDIR}/bin/hatching_dbs_halo
TASKDIRS="pretask task1 task2 task6"
EXECUTABLES="singleitr_hatching_dbs_halo multiviewitr_hatching_dbs_halo multiwindowitr_hatching_dbs_halo"
...
function pretask()
{
	...
	${BINDIR}/pretask/singleitr_hatching_dbs_halo \
...
function task1()
{
	...
	do
		...
		do
			...
			${BINDIR}/task1/singleitr_hatching_dbs_halo \
			-f \
...
function task2()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task2/singleitr_hatching_dbs_halo \
			-f \
...
function task3()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task3/singleitr_hatching_dbs_halo \
			-f \
...
function task4()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			${BINDIR}/task4/singleitr_hatching_dbs_halo \
			-f \
...
function task5()
{
	...
	do
		...
		do
			...
			${BINDIR}/task5/singleitr_hatching_dbs_halo \
			-f \
       ...
       #local trichoices=(rightcut nocut leftcut nocut rightcut)
        ...
        do
                ...
                do
                        ...
                        ${BINDIR}/task6/singleitr_hatching_dbs_halo \
                        -f \
